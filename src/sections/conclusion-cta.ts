  ...
  section.innerHTML = `
    <div class="container section-inner">
      <div class="cta-block">
        ...
        <p style="max-width:640px;margin:0 auto calc(var(--grid-unit)*1.5);">
        ...
        <p style="margin-bottom:calc(var(--grid-unit)*1);font-family:var(--font-heading);font-size:1.1rem;">
          B&#432;&#7899;c ti&#7871;p:
        </p>
        ...
        <p style="margin-top:calc(var(--grid-unit)*1.5);opacity:0.6;font-size:0.9rem;">
